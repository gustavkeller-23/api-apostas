    ...
    private static void handleLutadores(HttpExchange exchange) throws IOException {
        ...
        switch (exchange.getRequestMethod().toUpperCase()) {
            ...
            case "POST" -> {
                ...
                Integer categoria = parseIntOuNull(params.get("categoria"));
                Integer arte      = parseIntOuNull(params.get("arte"));
    ...
    private static void handleLutadorPorId(HttpExchange exchange) throws IOException {
        ...
        switch (exchange.getRequestMethod().toUpperCase()) {
            ...
            case "PUT" -> {
                ...
                if (params.containsKey("categoria")) existente.setCategoria(parseIntOuNull(params.get("categoria")));
                if (params.containsKey("arte"))      existente.setArte(parseIntOuNull(params.get("arte")));
